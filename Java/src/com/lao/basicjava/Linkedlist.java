...
public class Linkedlist {
	...
	public void linkedListOperationsExample(){
		...
		System.out.println("First Value using index  4:"+linkedList.get(0));
		...
		System.out.println("has :"+linkedList.poll());
		...
		linkedList.remove();
		System.out.println("total :"+linkedList);
	...
	public void iterateLinkedListWithSimpleFor(){
		...
		for (int i=0;i<linkedList.size();i++){
			System.out.println("Elements in the LL are "+ linkedList.get(i));
		}
		System.out.println("-----------------------------------------------------");
	}
